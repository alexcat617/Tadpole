...
| Consistency | One primary CTA (teal), secondary outline buttons, one card/accordion pattern; same empty and loading blocks | Strive for consistency | Consistency and standards |
